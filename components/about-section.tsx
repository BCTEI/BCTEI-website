...
const features = [
  {
    icon: Target,
    title: "رسالتنا",
    description: "نحوِّل المعرفة إلى قيمة صناعية واقتصادية عبر منظومة بحثية تطبيقية متكاملة، تجمع الأبحاث المتقدمة، المصانع الصغيرة القائمة على المواد المركبة، والمختبرات المتخصصة لدعم الصناعات الوطنية."
  },
  {
    icon: Eye,
    title: "رؤيتنا",
    description: "الريادة في بناء اقتصاد معرفي صناعي، وتحويل ليبيا إلى مركز إقليمي للابتكار والتصنيع الذكي في مجالات التقنية والهندسة التطبيقية."
  },
  {
    icon: Award,
    title: "قيمنا",
    description: "التكامل، الابتكار، الجودة والسلامة، الوطنية، والشراكة — قيم تقود مسيرتنا نحو بناء صناعة وطنية متقدمة."
  }
]
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              مركز البنيان هو منصة وطنية للابتكار والتطوير والتصنيع الذكي، يجمع بين الأبحاث المتقدمة والمصانع الصغيرة والمختبرات المتخصصة لدعم الصناعات الوطنية وتحويل المعرفة إلى قيمة اقتصادية حقيقية.
            </p>
